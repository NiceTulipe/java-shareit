...
public class ErrorHandlerController {
    ...
    @ExceptionHandler
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public Map<String, String> handleRequestFailedException(MissingRequestValueException exception) {
        log.warn("Error! RequestValueMissing: '{}' text message: '{}'", HttpStatus.INTERNAL_SERVER_ERROR, exception.getMessage());
        return Map.of("RequestValueMissing", Objects.requireNonNull(exception.getMessage()));
    }

    @ExceptionHandler
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorResponse handleBadRequestException(final RequestFailedException exception) {
