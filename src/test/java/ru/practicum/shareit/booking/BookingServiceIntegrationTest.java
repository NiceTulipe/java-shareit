...
public class BookingServiceIntegrationTest {
    ...
    private final BookItemRequestDto bookingToCreate = BookItemRequestDto.builder().itemId(1L).start(LocalDateTime.now().plusHours(1))
    ...
    void getAllBookingsByUser_ALL(String status, int start, int end, boolean approve) {
        BookItemRequestDto booking = BookItemRequestDto.builder().itemId(1L)
    ...
    public void checkDates_PositiveTestCase() {
        ...
        bookingServiceImpl.checkDates(bookingDto);
    }
    ...
    public void approve_withInvalidOwnerId_shouldThrowNotFoundException() {
        ...
        Exception exception = assertThrows(ObjectNotFoundException.class, () -> bookingService.approve(ownerId, bookingId, approved));
